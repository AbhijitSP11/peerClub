...
const TermsAndConditions = () => {
    ...
    return (
        <div>
            <FinalHero text={'Terms and conditions'} />
            <div className={styles.container}>
                <h2>Welcome to Canada gateway!</h2>
                <br />
                <p>
                    These terms and conditions outline the rules and regulations
                    for the use of Canada gateway's Website, located at
                    https://canadagateway.com.
                </p>
                <br />
                <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Canada gateway if you
                ...
                <p>
                    We employ the use of cookies. By accessing Canada gateway,
                    you agreed to use cookies in agreement with the Canada
                    gateway's Privacy Policy.{' '}
                </p>
                ...
                <p>
                    Unless otherwise stated, Canada gateway and/or its licensors
                    own the intellectual property rights for all material on
                    Canada gateway. All intellectual property rights are
                    reserved. You may access this from Canada gateway for your
                ...
                <p>You must not:</p>
                <ul>
                    <li>Republish material from Canada gateway</li>
                    <li>
                        Sell, rent or sub-license material from Canada gateway
                    </li>
                    <li>
                        Reproduce, duplicate or copy material from Canada
                        gateway
                    </li>
                    <li>Redistribute content from Canada gateway</li>
                </ul>
                ...
                <p>
                    ...
                    the website. Canada gateway does not filter, edit, publish
                    or review Comments prior to their presence on the website.
                    Comments do not reflect the views and opinions of Canada
                    gateway,its agents and/or affiliates. Comments reflect the
                    views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, Canada
                    gateway shall not be liable for the Comments or for any
                ...
                <p>
                    Canada gateway reserves the right to monitor all Comments
                ...
                <p>
                    You hereby grant Canada gateway a non-exclusive license to
                    use, reproduce, edit and authorize others to use, reproduce
                    and edit any of your Comments in any and all forms, formats
                    or media.
                </p>
                ...
                <p>
                    ...
                    compensates the absence of Canada gateway; and (d) the link
                ...
                <p>
                    ...
                    inform us by sending an e-mail to Canada gateway. Please
                ...
                <p>
                    No use of Canada gateway's logo or other artwork will be
